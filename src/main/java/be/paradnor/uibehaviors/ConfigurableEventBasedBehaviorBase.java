 ...
 */
public abstract non-sealed class ConfigurableEventBasedBehaviorBase<T extends BehaviorTarget<?>, C extends BehaviorConfiguration<T>> implements ConfigurableBehavior<T, C>, EventBasedBehavior<T> {
    protected T target;
    protected C configuration;
    private boolean attached = false;

    protected ConfigurableEventBasedBehaviorBase() {
    }
